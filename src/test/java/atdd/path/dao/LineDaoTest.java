...
public class LineDaoTest {
    ...
    public void findByIdWithEdges() {
        ...
        int distance = 10;
        int elapsedTime = 10;
        edgeDao.save(savedLine.getId(), Edge.of(station1, station2, distance, elapsedTime));
        edgeDao.save(savedLine.getId(), Edge.of(station2, station3, distance, elapsedTime));
        edgeDao.save(savedLine.getId(), Edge.of(station3, station4, distance, elapsedTime));
    ...
    public void findAllWithEdges() {
        ...
        edgeDao.save(savedLine.getId(), Edge.of(station1, station2, distance, elapsedTime));
        edgeDao.save(savedLine.getId(), Edge.of(station2, station3, distance, elapsedTime));
        edgeDao.save(savedLine2.getId(), Edge.of(station3, station4, distance, elapsedTime));
        edgeDao.save(savedLine2.getId(), Edge.of(station4, station1, distance, elapsedTime));
